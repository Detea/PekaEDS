...
void TilesetRenderer::draw(QPainter& painter, const QImage* tilesetImage, const QRect& selectionRect) {
...
void TilesetRenderer::drawTileset(QPainter& painter, const QImage& tilesetImage) {
